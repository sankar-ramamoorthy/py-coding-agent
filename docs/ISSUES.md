...
| ISS-004 | Add kb-template/ portable knowledge-base scaffold | done | kb-template | 2026-08-03 session | Landed in commits `1dd949f`, `b12cc64`, `c3f8f80` on branch `kb-template`. Reusable YAML front-matter + Obsidian-markdown scaffold with a standalone validator, extracted before further cross-project knowledge-base drift accumulates. See `specs/001-kb-template/`. |
